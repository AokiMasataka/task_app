<template>
    ...
    >
        <div
            class="flex mb-4 items-center justify-between sticky top-0 z-40 bg-neutral-700"
        >
            <h1 class="m-6 text-2xl">{{ props.displayStatus }}</h1>
            <AddTaskBtn class="m-4" @on-click="handleAddTaskBtn" />
        </div>
...
async function handleFecthTask(
    task_id: string,
    isPreviewMode: boolean
): Promise<void> {
